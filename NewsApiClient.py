...
class NewsApiClient:
    ...
    def get_news_by_topic(self, topic, language_code, date_from="", limit=100):
        news_api_url = f'https://newsapi.org/v2/everything?q={topic}&apiKey={self.api_key}&pageSize={limit}'
